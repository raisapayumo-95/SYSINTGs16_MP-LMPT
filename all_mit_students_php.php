    ...
    <div class="container-fluid">
	  <div class="row">
	   ...
	   <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h1 class="page-header">MIT Students</h1>
		...
		<form method = "post">
			<div class="form-group">
				...
				<?php 
					$student[] = array();
					$selectage = "SELECT distinct truncate(datediff(date(now()), birthday)/365.25,0) FROM university_data.student where university = 'Mapua Institute of Technology'
					order by 1";
		...
		<br>
		  <?php
			$sql = "SELECT firstname, surname, birthday, university FROM student where university='Mapua Institute of Technology'";
		  ...
		  <br>
			...
			if ( empty($_POST['student']) && (isset($_POST['asc']) || isset($_POST['desc'])))
			{
				if (isset($_POST['asc']))
				{
					...
					FROM student where university='Mapua Institute of Technology' ORDER BY 
			...
			else if (isset($_POST['asc']) || isset($_POST['desc']))
			{
				...
				FROM student where university='Mapua Institute of Technology'
